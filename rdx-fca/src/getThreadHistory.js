    ...
    defaultFuncs
      ...
      .then(function (resData) {
        ...
        if (resData[resData.length - 1].error_results !== 0) {
          // Silently return empty array — Facebook temporary error, not fatal
      ...
      .catch(function (err) {
        ...
        // Suppress noisy non-fatal errors from Facebook API
        if (!msg.includes('error_result') && !msg.includes('error_results')) {
