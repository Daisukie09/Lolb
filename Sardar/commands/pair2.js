...
const templateUrl = "https://i.ibb.co/KRJTnnm/d018229088a5.jpg";
...
module.exports = {
  config: {
    ...
    name: "pair2",
    aliases: ["couple", "love"],
    description: "Romantic pair image banao. Bilkul free!",
    usage: "pair2 [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
  async run({ api, event, send, Users, Currencies }) {
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '💞', '𝐏𝐚𝐢𝐫', 'pair2');
