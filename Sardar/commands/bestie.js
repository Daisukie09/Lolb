...
const templateUrl = "https://i.ibb.co/yFmMm5bg/e993353ed645.jpg";
const templatePath = path.join(cacheDir, "bestie_template.png");
...
const bestieMessages = [
  ...
  "𝐅𝐨𝐫𝐞𝐯𝐞𝐫 𝐀𝐧𝐝 𝐀𝐥𝐰𝐚𝐲𝐬 𝐌𝐲 𝐁𝐞𝐬𝐭𝐢𝐞 🖤👑",
  "𝐁𝐞𝐬𝐭 𝐅𝐫𝐢𝐞𝐧𝐝𝐬 𝐀𝐫𝐞 𝐇𝐚𝐫𝐝 𝐓𝐨 𝐅𝐢𝐧𝐝 🖤🦋",
  "𝐌𝐲 𝐁𝐞𝐬𝐭𝐢𝐞 𝐌𝐲 𝐋𝐢𝐟𝐞 🖤✨",
  "𝐂𝐚𝐧'𝐭 𝐒𝐭𝐨𝐩 𝐋𝐨𝐯𝐢𝐧𝐠 𝐘𝐨𝐮 𝐁𝐞𝐬𝐭𝐢𝐞 🖤💫",
...
module.exports = {
  config: {
    credits: "SARDAR RDX",
    name: "bestie",
    aliases: ["bff", "bestfriend", "bestiepair"],
    description: "Bestie pair image banao — Diamond Circle style.",
    usage: "bestie [@mention / reply]",
    category: "Love",
    prefix: true,
    cooldowns: 5
  },
  async run({ api, event, send, Users, Currencies }) {
    ...
    const { msgID: loadMsgID, done: animDone } = await animateProgress(api, threadID, messageID, '🖤', '𝐁𝐞𝐬𝐭𝐢𝐞 𝐏𝐚𝐢𝐫', 'bestie');
    ...
    try {
      ...
      const outputPath = path.join(cacheDir, `bestie_${one}_${two}_${Date.now()}.png`);
